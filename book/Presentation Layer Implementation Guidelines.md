 ...
 * [ ] آیا Requestها و Responseها در پروژه جداگانه Contracts تعریف شده‌اند؟
 * [ ] آیا کنترلر فاقد هرگونه لاجیک شرطی (if/else بیزینسی) است؟
 * [ ] آیا کنترلر به جز ISender و IMapper وابستگی دیگری دریافت کرده است (نباید دریافت کند)؟
 * [ ] آیا در صورت بروز خطا، خروجی به صورت استانداردِ ProblemDetails بازگردانده می‌شود؟
 * [ ] آیا نوع ارورهای بیزینسی (ErrorOr) به درستی به Status Codeهای HTTP تبدیل شده‌اند؟
 * [ ] آیا Endpointها (مسیرهای API) بر اساس اصول استاندارد RESTful نام‌گذاری شده‌اند؟
